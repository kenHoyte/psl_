        ...
        <ul class="list-unstyled topbar-nav float-right mb-0"> 
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                    ...
                    <span class="ml-1 nav-user-name hidden-sm">{{ Auth::user()->firstname }} <i class="mdi mdi-chevron-down"></i> </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-lg-6">
                            <div class="text-center system-text">
                                ...
                                <a href="../../metrica/index.html" class="btn btn-sm btn-pink mt-2">See Dashboard</a>
                            </div>
